            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    <div class="col text-right">
                        <a href="{{ url('admin/news/create') }}" type="submit" class="btn btn-info mb-2"><i class="fas fa-plus"></i>
                            新規追加</a>
                    </div>
                            ...
                            <table class="table table-hover text-nowrap table-list table-center">
                                ...
                                <tbody>
                                    @foreach($records as $record)
                                        <tr>
                                            <td>{{ dateTimeFormat($record->publish_date, 'Y.m.d') }}</td>
                                            <td>{{ $record->title }}</td>
                                            <td class="project-actions text-right">
                                                <a href="{{ url('admin/news/'. $record->id .'/edit') }}" class=" btn btn-info btn-sm">
