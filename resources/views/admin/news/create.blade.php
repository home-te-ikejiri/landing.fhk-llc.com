    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="card card-outline card-primary">
                ...
                <form action="{{ url('admin/news') }}" method="post" autocomplete="off">
                    <div class="card-body">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="text" id="inputTest" class="form-control" name="title" value="{{ old('title') }}">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="w-50">
                                                <input type="text" class="form-control" id="date" name="publish_date" value="{{ old('publish_date') }}">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <textarea id="tinymce" class="form-control" rows="12" name="details">{!! e(old('details')) !!}</textarea>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
