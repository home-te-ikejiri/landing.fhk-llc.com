    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="card card-outline card-primary">
                ...
                <form action="{{ url('admin/event/' . $record->id) }}" method="post" autocomplete="off">
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="w-25">
                                                <input type="date" class="form-control" name="event_date" value="{{ old('event_date', $record->event_date->format('Y-m-d')) }}">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="w-25">
                                                <input type="time" class="form-control" name="start_time" value="{{ old('start_time', substr($record->start_time, 0, 5)) }}">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="w-25">
                                                <input type="time" class="form-control" name="end_time" value="{{ old('end_time', substr($record->end_time, 0, 5)) }}">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="w-25">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" name="capacity" value="{{ old('capacity', $record->capacity) }}" min="1">
                                        ...
                                        <td>
                                            ...
                                            <div class="w-25">
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control" name="price" value="{{ old('price', $record->price) }}" min="0">
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <textarea class="form-control" rows="5" name="description">{{ old('description', $record->description) }}</textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="url" class="form-control" name="external_url" value="{{ old('external_url', $record->external_url) }}" placeholder="https://...">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <select class="form-control w-25" name="status">
                                                <option value="0" {{ old('status', $record->status) == 0 ? 'selected' : '' }}>非公開</option>
                                                <option value="1" {{ old('status', $record->status) == 1 ? 'selected' : '' }}>公開</option>
                                                <option value="2" {{ old('status', $record->status) == 2 ? 'selected' : '' }}>終了</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
