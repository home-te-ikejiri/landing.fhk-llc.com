        ...
        <section class="content">
            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title">FAQカテゴリ一覧</h3>
                ...
                <div class="card-body">
                    <div class="col text-right">
                        <a href="{{ url('admin/faq-category/create') }}" type="submit" class="btn btn-info mb-2"><i class="fas fa-plus"></i>
                            新規追加</a>
                    </div>
                                    ...
                                    @foreach($records as $record)
                                        <tr>
                                            ...
                                            <td class="project-actions text-right">
                                                <a href="{{ url('admin/faq-category/'. $record->id .'/edit') }}" class=" btn btn-info btn-sm">
