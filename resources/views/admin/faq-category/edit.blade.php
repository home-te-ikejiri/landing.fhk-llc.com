    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="card card-outline card-primary">
                ...
                <form action="{{ url('admin/faq-category/'.$record->id) }}" method="post" autocomplete="off">
                    <div class="card-body">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="text" id="inputTest" class="form-control" name="name" value="{{ old('name', $record->name) }}">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
