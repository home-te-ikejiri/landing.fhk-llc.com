            ...
            <div class="row align-items-center g-4">
                ...
                <div class="col-md-6">
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        ...
                        {{-- <a href="#store" class="btn btn-outline-accent px-4 py-2">
                            <i class="bi bi-geo-alt-fill me-1"></i> 店舗について
                        </a> --}}
                        <a href="https://stores.jp" target="_blank" class="btn btn-outline-accent px-4 py-2">
                ...
                <div class="col-md-6 text-center">
                    {{--
                        【画像が必要】メインビジュアル
                        イメージ：木のぬくもりとコーヒーを感じさせる、温かみのある横長写真
                        例）木製テーブルの上に置かれたコーヒーカップと木製小物、柔らかい自然光
                        推奨サイズ：横 900px × 縦 600px 以上
                        ファイル名案：images/user/fhk-hero.jpg
                        
                    --}}
                    {{-- 【画像】メインビジュアル
木のぬくもりとコーヒーを感じるイメージ写真
（例：木のテーブル＋コーヒーカップ） --}}
                    <img src="{{ asset('images/user/fhk-hero2.png') }}" class="img-fluid rounded" alt="FHK メインビジュアル">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-md-8">
                    ...
                    <p class="concept-body mb-4">
                        合同会社FHK（フィーカ）は、<br>
                        人と人、人と時間が、無理なくつながれる「場」を大切にするため「珈琲えんがわ」を作りました。
                    </p>
                    <p class="concept-lead">
